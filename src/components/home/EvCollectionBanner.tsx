...
export default function EvCollectionBanner() {
  return (
    <section className="relative h-[342px] w-full overflow-hidden md:h-[540px] lg:h-[807px]">
      <Image
      ...
      <div className="font-avenir absolute inset-0 flex flex-col justify-center gap-6 px-5 py-10 text-white lg:gap-10 lg:px-[73px]">
        <h2 className="max-w-[778px] text-[24px] font-bold leading-[normal] lg:text-[70px]">
          EXPLORE OUR LATEST EV COLLECTION
        </h2>
        <p className="max-w-[674px] text-[14px] leading-[normal] lg:text-[24px]">
        ...
        <Link
          ...
          className="w-fit text-[16px] font-bold leading-[normal] underline underline-offset-4 lg:text-[36px]"
        >
          Discover More
        </Link>
      </div>
